    ...
    <>
      <div className="navbar-main flex">
        <button
          ...
          className=" relative top-0 left-8 bottom-4 text-2xl bg-gray-800 p-2 rounded-full text-white z-50"
        >
      ...
      <div
        className={`bg-gray-800 h-full fixed lg:fixed  w-[80%] md:w-[40%] lg:w-[30%] xl:w-[20%] transition-all z-50 duration-300 ${
